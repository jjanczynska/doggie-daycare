# Generated by Django 3.2.20 on 2023-08-23 16:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dog', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reservations', to='islandersdogdaycare.dog')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reservations', to='islandersdogdaycare.owner')),
            ],
        ),
        migrations.CreateModel(
            name='ExtraInfo',
